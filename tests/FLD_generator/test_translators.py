...
def test_jpn_postprocess():
    ...
    _check_katsuyou('それはアシュリーでそれは王土だない', ['それはアシュリーでそれは王土でない'])
    _check_katsuyou('もしあるものが英朋でないならば「それはアシュリーでそれは王土だない」ということは成り立たない',
                    ['もしあるものが英朋でないならば「それはアシュリーでそれは王土でない」ということは成り立たない'])
    _check_katsuyou('もしあるものが英朋でないならば「それはアシュリーでそれは王土だない」ということは成り立たない',
                    ['もしあるものが英朋でないならば「それはアシュリーでそれは王土でない」ということは成り立たない'])
    _check_katsuyou('そのプロレタリアがサッシだないし越後を振りかぶる', ['そのプロレタリアがサッシでないし越後を振りかぶる'])
    _check_katsuyou('もしあの種牛は神子様だないしセゾンだということがないならばあの種牛はシンエイだということはない',
                    ['もしあの種牛は神子様でないしセゾンだということがないならばあの種牛はシンエイだということはない'])
    _check_katsuyou('もしあるものは神子様だということはないしセゾンでないならばそれはシンエイだない',
                    ['もしあるものは神子様だということはないしセゾンでないならばそれはシンエイでない'])
