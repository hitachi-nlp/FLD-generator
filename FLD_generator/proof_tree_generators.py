...
class GenerateTreeFailure(ProofTreeGenerationFailure):
    pass
...
class GenerateTreeImpossible(ProofTreeGenerationImpossible):
    pass
    ...
    def __init__(self,
        ...
        if not math.isclose(quantifier_arguments_weight, 0.0):
            raise NotImplementedError('Currently, the arguments generated by generate_partially_quantifier_arguments()'
                                      'such as "(x) Fa v Gx" is not supported by the translation configuration.')
        knowledge_banks = knowledge_banks or []
    ...
    for config_path in config_paths:
        ...
        for _path in all_paths:
            arguments.extend([Argument.from_json(json_obj)
                              for json_obj in json.load(open(str(_path)))
